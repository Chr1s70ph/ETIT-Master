...
exports.Command = async (client: DiscordClient, interaction: DiscordChatInputCommandInteraction): Promise<void> => {
  ...
  const embed = new EmbedBuilder()
    .setTitle(
      `${client.translate({
        key: 'interactions.channelinfo.channelinfo',
    ...
    .addFields([
      {
        name: `${client.translate({
          key: 'interactions.channelinfo.name',
          options: { lng: interaction.user.language },
        })}:`,
      ...
      {
        name: `${client.translate({
          key: 'interactions.channelinfo.created_at',
          options: { lng: interaction.user.language },
        })}:`,
      ...
      {
        name: `${client.translate({
          key: 'interactions.channelinfo.parent',
          options: { lng: interaction.user.language },
        })}:`,
      ...
      {
        name: `${client.translate({
          key: 'interactions.channelinfo.type',
          options: { lng: interaction.user.language },
        })}:`,
        value: `[${
      ...
      {
        name: `${client.translate({
          key: 'interactions.channelinfo.id',
          options: { lng: interaction.user.language },
        })}:`,
      ...
      {
        name: `${client.translate({
          key: 'interactions.channelinfo.guild_id',
          options: { lng: interaction.user.language },
        })}:`,
